...
この書込みPhaseの実装は [Issue #12](https://github.com/xzyozi/agent-config-viewer/issues/12) で追跡する。Phase 2のread-only計画表示は、コピー・移動の完了を意味しない。
...
| Rev.1.1 | 2026-09-11 | xzyozi | 実パス変更の書込みPhaseをIssue #12で追跡することを追加。   |